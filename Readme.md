...
|-----------|--------------|--------|
| Bloquecidio Matemático | Juego educativo de lógica y cálculo | ![Bloquecidio](Images/Bloquecidio%20Matemático.png) |
| Fuera de Pantalla| Juego de decisiones y rutas que recapacitan al jugador| ![Fuera de Pantalla](Images/Fuera%20de%20la%20Pantalla.png) |
| Reci-Trail| Juego de conciencia al cuidado del medio ambiente | ![Reci-Trail](Images/reci-trail.png) |
| Life-Jump| Juego plataformeo y de comida | ![Bloquecidio](Images/Life-Jump.png) |
| Cookie Diner | Juego de Cocina y de ahorro de dinero | ![Cookie Diner](Images/CookieDinner.png) |
| Gestión de Agua | Simulación de reparaciones y recursos | ![Guardianes del Agua](Images/Guardianes_del_Agua.png) |
